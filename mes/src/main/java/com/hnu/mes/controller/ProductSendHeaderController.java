 ...
 */
@RestController
@RequestMapping(name = "/productSendHeader")
public class ProductSendHeaderController {
    ...
    public Result<ProductSendHeader> add(@RequestBody ProductSendHeader productSendHeader, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return ResultUtil.error(bindingResult.getFieldError().toString());
        }

        if (productSendHeader.getApplicant() == null || userService.findOne(productSendHeader.getApplicant().getCode()) == null) {
    ...
    public Result<ProductSendHeader> update(@RequestBody ProductSendHeader productSendHeader, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return ResultUtil.error(bindingResult.getFieldError().toString());
        }

        if (productSendHeader == null || productSendHeader.getCode() == null || productSendHeaderService.findOne(productSendHeader.getCode()) == null) {
    ...
    public Result<Page<ProductSendHeader>> findByAuditStatusByPage(Integer auditStatus, @RequestParam(value = "page", defaultValue = "0") Integer page,
                                                                   @RequestParam(value = "size", defaultValue = "10") Integer size,
                                                                   @RequestParam(value = "sort", defaultValue = "code") String sort,
                                                                   @RequestParam(value = "asc", defaultValue = "1") Integer asc) {
    ...
    public Result<Page<ProductSendHeader>> findByCreateDateByPage(Long createDate, @RequestParam(value = "page", defaultValue = "0") Integer page,
                                                                  @RequestParam(value = "size", defaultValue = "10") Integer size,
                                                                  @RequestParam(value = "sort", defaultValue = "code") String sort,
                                                                  @RequestParam(value = "asc", defaultValue = "1") Integer asc) {
    ...
    public Result<Page<ProductSendHeader>> findByRawTypeByPage(Long rawTypeCode, @RequestParam(value = "page", defaultValue = "0") Integer page,
                                                               @RequestParam(value = "size", defaultValue = "10") Integer size,
                                                               @RequestParam(value = "sort", defaultValue = "code") String sort,
                                                               @RequestParam(value = "asc", defaultValue = "1") Integer asc) {
    ...
    public Result<Page<ProductSendHeader>> findByAuditStatusAndCreateDateByPage(Integer auditStatus, Long createDate, @RequestParam(value = "page", defaultValue = "0") Integer page,
                                                                                @RequestParam(value = "size", defaultValue = "10") Integer size,
                                                                                @RequestParam(value = "sort", defaultValue = "code") String sort,
                                                                                @RequestParam(value = "asc", defaultValue = "1") Integer asc) {
        return ResultUtil.success(productSendHeaderService.findByAuditStatusAndCreateDateByPage(auditStatus, createDate, page, size, sort, asc));
    }
    ...
    public Result<Page<ProductSendHeader>> findByAuditStatusAndRawTypeByPage(Integer auditStatus, Long rawTypeCode, @RequestParam(value = "page", defaultValue = "0") Integer page,
                                                                             @RequestParam(value = "size", defaultValue = "10") Integer size,
                                                                             @RequestParam(value = "sort", defaultValue = "code") String sort,
                                                                             @RequestParam(value = "asc", defaultValue = "1") Integer asc) {
        RawType rawType = new RawType();
        rawType.setCode(rawTypeCode);
        return ResultUtil.success(productSendHeaderService.findByAuditStatusAndRawTypeByPage(auditStatus, rawType, page, size, sort, asc));
    }
    ...
    public Result<Page<ProductSendHeader>> findByCreateDateAndRawTypeByPage(Long createDate, Long rawTypeCode, @RequestParam(value = "page", defaultValue = "0") Integer page,
                                                                            @RequestParam(value = "size", defaultValue = "10") Integer size,
                                                                            @RequestParam(value = "sort", defaultValue = "code") String sort,
                                                                            @RequestParam(value = "asc", defaultValue = "1") Integer asc) {
        RawType rawType = new RawType();
        rawType.setCode(rawTypeCode);
        return ResultUtil.success(productSendHeaderService.findByCreateDateAndRawTypeByPage(createDate, rawType, page, size, sort, asc));
    }
    ...
    public Result<Page<ProductSendHeader>> findByAuditStatusAndRawTypeAndCreateDateByPage(@RequestParam(value = "auditStatus", defaultValue = "-1") Integer auditStatus,
        ...
        if (auditStatus == -1 && rawTypeCode == -1 && createDate != -1) {
            ...
            RawType rawType = new RawType();
            rawType.setCode(rawTypeCode);
            return ResultUtil.success(productSendHeaderService.findByAuditStatusAndRawTypeAndCreateDateByPage(auditStatus, createDate, rawType, page, size, sort, asc));
        }
    ...
    public Result<Object> updateAuditStatusByCode(Integer auditStatus, String note, Long code, String auditCode) {
        ...
        if (productSendHeader.getAuditStatus() == GlobalUtil.ProductSendStatus.APPROVE || productSendHeader.getAuditStatus() == GlobalUtil.ProductSendStatus.NOT_APPROVE) {
    ...
    public Result<Object> updateOutStatusAndApplicantAndApplyTimeByCode(Integer outStatus, String senderCode, Long code){
